...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        // Validaciones
        if (!datosJuego.nombre || !datosJuego.desarrolladora || datosJuego.consolas.length === 0) {
            mensaje.textContent = "Por favor, completa todos los campos obligatorios (incluyendo al menos una plataforma)";
            mensaje.className = "font-pixel text-center mt-4 text-red-500";
            return;
        }
