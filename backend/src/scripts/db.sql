...
INSERT INTO juegos (nombre, descripcion, desarrolladora, genero, url_imagen) VALUES
('The Legend of Zelda: Breath of the Wild', 'Aventura en mundo abierto', 1, 'Aventura', 'https://ejemplo.com/zelda.png'),
('God of War', 'Acción y mitología nórdica', 2, 'Acción', 'https://ejemplo.com/godofwar.png'),
('Grand Theft Auto V', 'Acción y mundo abierto', 4, 'Acción', 'https://ejemplo.com/gta.png'),
('The Witcher 3: Wild Hunt', 'RPG en mundo abierto', 5, 'RPG', 'https://ejemplo.com/witcher3.png'),
('Half-Life: Alyx', 'Shooter en VR', 3, 'Shooter', 'https://ejemplo.com/alyx.png');
